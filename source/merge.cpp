...
int main() {
    ...
    // notice if we merge two sorted lists -- the merged list is also sorted
    list1.sort();
    list2.sort();
    list1.merge(list2);
    cout<< "merding lists after sorting them  ";
    print_list(list1);
    ...
    // to explore more capabilities of lists in C++ using STL
